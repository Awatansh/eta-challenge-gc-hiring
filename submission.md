...
# 1) Download raw train/dev parquet files
python data/download_data.py

# 2) Build enriched zone features and zone reference data
python sim/fetch_zone_features.py

# 3) Train the model from the available parquet files
python solution/train_model.py

# 4) Compare baseline vs. solution on Dev
